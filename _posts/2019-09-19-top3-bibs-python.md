...
[**Aqui**]({{ "/posts/install-python/" | relative_url }}) você já aprendeu a instalar o Python,  e aqui você aprendeu fazer o primeiro programada em Python, agora instalaremos as top 5 bibliotecas Python para Ciências de Dados
